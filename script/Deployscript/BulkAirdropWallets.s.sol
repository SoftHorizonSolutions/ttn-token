...
/**
 * @title BulkAirdropWallets
 * @dev Bulk airdrop to wallet addresses using executeAirdrop function
 */
contract BulkAirdropWallets is Script {
    ...
    function run() external {
        ...
        console.log("=== Bulk Wallets Airdrop ===");
